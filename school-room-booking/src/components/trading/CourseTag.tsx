...
export default function CourseTag({ courseCode, courseName, type, classCode, section, schedule }: CourseTagProps) {
  ...
  return (
    <div className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium border ${colors}`}>
      ...
      {classCode && <span className="text-xs opacity-60">[{classCode}]</span>}
